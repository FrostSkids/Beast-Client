...
public class SplashProgress
{
    ...
    private static void drawProgress() {
        ...
        GlStateManager.resetColor();
        resetTextureState();
        SplashProgress.ufr.drawString("Changelog:", 20.0f, (float)(sr.getScaledHeight() - 225), 39423);
        SplashProgress.ufr.drawString("[+] Save toggled mods", 20.0f, (float)(sr.getScaledHeight() - 210), 65280);
        SplashProgress.ufr.drawString("[+] TNT timer Mod", 20.0f, (float)(sr.getScaledHeight() - 195), 65280);
        SplashProgress.ufr.drawString("bug fixes", 20.0f, (float)(sr.getScaledHeight() - 180), 16777215);
        SplashProgress.ufr.drawString(SplashProgress.CURRENT, 20.0f, (float)(sr.getScaledHeight() - 25), -1);
        final String step = SplashProgress.PROGRESS + "/" + 7;
