...
public class GuiIngameMods extends GuiScreen
{
    ...
    public void initGui() {
        ...
        if (Client.ModPosition) {
            this.buttonList.add(new GuiButton(1011, this.width / 2 - 61, this.height / 2 + 54, 120, 20, I18n.format("Coordinates: ON", new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(1011, this.width / 2 - 61, this.height / 2 + 54, 120, 20, I18n.format("Coordinates: OFF", new Object[0])));
        }
        if (Client.ModBiom) {
        ...
        switch (button.id) {
            ...
            case 1005: {
                ...
                if (Client.ModFPS) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModFPS", Client.ModFPS);
                    break;
                }
                if (!Client.ModFPS) {
            ...
            case 1006: {
                ...
                if (Client.ModKeystrokes) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModKeystrokes", Client.ModKeystrokes);
                    break;
                }
                if (!Client.ModKeystrokes) {
            ...
            case 1007: {
                ...
                if (Client.ModPing) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModPing", Client.ModPing);
                    break;
                }
                if (!Client.ModPing) {
            ...
            case 1008: {
                ...
                if (Client.ModArmorStatus) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModArmorStatus", Client.ModArmorStatus);
                    break;
                }
            ...
            case 1009: {
                ...
                if (Client.ModTimeShow) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModTimeShow", Client.ModTimeShow);
                    break;
                }
            ...
            case 1010: {
                ...
                if (Client.ModPotionstatus) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModPotionstatus", Client.ModPotionstatus);
                    break;
                }
            ...
            case 1011: {
                ...
                if (Client.ModPosition) {
                    this.buttonList.set(6, new GuiButton(1011, this.width / 2 - 61, this.height / 2 + 54, 120, 20, I18n.format("Coordinates: ON", new Object[0])));
                    ModToggle.saveIsEnabledToFile("ModPosition", Client.ModPosition);
                    break;
                }
                this.buttonList.set(6, new GuiButton(1011, this.width / 2 - 61, this.height / 2 + 54, 120, 20, I18n.format("Coordinates: OFF", new Object[0])));
                ModToggle.saveIsEnabledToFile("ModPosition", Client.ModPosition);
                break;
            }
            case 1021: {
                ...
                if (Client.ModBiom) {
                    ...
                    ModToggle.saveIsEnabledToFile("ModBiom", Client.ModBiom);
                    break;
                }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, Client.ModFarbe + "Ingame Mods", this.width / 2 - 31, this.height / 2 - 120, -1);
