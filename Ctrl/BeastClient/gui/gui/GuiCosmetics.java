...
import Ctrl.BeastClient.CosmeticToggle;
...
public class GuiCosmetics extends GuiScreen
{
    ...
    public void initGui() {
        ...
        if (Client.CosmeticCape) {
            this.buttonList.add(new GuiButton(1003, this.width / 2 - 61, this.height / 2 - 18, 120, 20, I18n.format("Cape Logo: ON", new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(1003, this.width / 2 - 61, this.height / 2 - 18, 120, 20, I18n.format("Cape Logo: OFF", new Object[0])));
        }
        ...
        if (Client.CosmeticCape2) {
            this.buttonList.add(new GuiButton(4000, this.width / 2 - 61, this.height / 2 + 102, 120, 20, I18n.format("Cape Neon red: ON", new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(4000, this.width / 2 - 61, this.height / 2 + 102, 120, 20, I18n.format("Cape Neon red: OFF", new Object[0])));
        }
        if (Client.CosmeticCape3) {
            this.buttonList.add(new GuiButton(4001, this.width / 2 - 61, this.height / 2 + 126, 120, 20, I18n.format("Cape Neon blue: ON", new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(4001, this.width / 2 - 61, this.height / 2 + 126, 120, 20, I18n.format("Cape Neon blue: OFF", new Object[0])));
        }
        if (Client.CosmeticCape4) {
            this.buttonList.add(new GuiButton(4002, this.width / 2 - 61, this.height / 2 + 150, 120, 20, I18n.format("Cape Neon green: ON", new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(4002, this.width / 2 - 61, this.height / 2 + 150, 120, 20, I18n.format("Cape Neon green: OFF", new Object[0])));
        }
        this.buttonList.add(new GuiButton(8, this.width / 2 - 91, this.height / 2 + 174, 180, 20, I18n.format("Back", new Object[0])));
    }
        ...
        switch (button.id) {
            ...
            case 1001: {
                ...
                if (Client.CosmeticWings) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("CosmeticWings", Client.CosmeticWings);
                    break;
                }
            ...
            case 1003: {
                ...
                if (Client.CosmeticCape) {
                    this.buttonList.set(3, new GuiButton(1003, this.width / 2 - 61, this.height / 2 - 18, 120, 20, I18n.format("Cape Logo: ON", new Object[0])));
                    CosmeticToggle.saveIsEnabledToFile("CosmeticCape", Client.CosmeticCape);
                    break;
                }
                this.buttonList.set(3, new GuiButton(1003, this.width / 2 - 61, this.height / 2 - 18, 120, 20, I18n.format("Cape Logo: OFF", new Object[0])));
                CosmeticToggle.saveIsEnabledToFile("CosmeticCape", Client.CosmeticCape);
                break;
            }
            case 1004: {
                ...
                if (Client.CosmeticHalo) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("CosmeticHalo", Client.CosmeticHalo);
                    break;
                }
            ...
            case 1014: {
                ...
                if (Client.DiamondHead) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("DiamondHead", Client.DiamondHead);
                    break;
                }
            ...
            case 1016: {
                ...
                if (Client.CosmeticWitchHat) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("CosmeticWitchHat", Client.CosmeticWitchHat);
                    break;
                }
            ...
            case 1002: {
                ...
                if (Client.CosmeticGhostWings) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("CosmeticGhostWings", Client.CosmeticGhostWings);
                    break;
                }
            ...
            case 1005: {
                ...
                if (Client.CosmeticCap) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("CosmeticCap", Client.CosmeticCap);
                    break;
                }
            ...
            case 1006: {
                ...
                if (Client.CosmeticHat) {
                    ...
                    CosmeticToggle.saveIsEnabledToFile("CosmeticHat", Client.CosmeticHat);
                    break;
                }
            ...
            case 4000: {
                Client.CosmeticCape2 = !Client.CosmeticCape2;
                if (Client.CosmeticCape2) {
                    this.buttonList.set(8, new GuiButton(4000, this.width / 2 - 61, this.height / 2 + 102, 120, 20, I18n.format("Cape Neon Red: ON", new Object[0])));
                    CosmeticToggle.saveIsEnabledToFile("CosmeticCape2", Client.CosmeticCape2);
                    break;
                }
                this.buttonList.set(8, new GuiButton(4000, this.width / 2 - 61, this.height / 2 + 102, 120, 20, I18n.format("Cape Neon Red: OFF", new Object[0])));
                CosmeticToggle.saveIsEnabledToFile("CosmeticCape2", Client.CosmeticCape2);
                break;
            }
            case 4001: {
                Client.CosmeticCape3 = !Client.CosmeticCape3;
                if (Client.CosmeticCape3) {
                    this.buttonList.set(9, new GuiButton(4001, this.width / 2 - 61, this.height / 2 + 126, 120, 20, I18n.format("Cape Neon blue: ON", new Object[0])));
                    CosmeticToggle.saveIsEnabledToFile("CosmeticCape3", Client.CosmeticCape3);
                    break;
                }
                this.buttonList.set(9, new GuiButton(4001, this.width / 2 - 61, this.height / 2 + 126, 120, 20, I18n.format("Cape Neon blue: OFF", new Object[0])));
                CosmeticToggle.saveIsEnabledToFile("CosmeticCape3", Client.CosmeticCape3);
                break;
            }
            case 4002: {
                Client.CosmeticCape4 = !Client.CosmeticCape4;
                if (Client.CosmeticCape4) {
                    this.buttonList.set(10, new GuiButton(4002, this.width / 2 - 61, this.height / 2 + 150, 120, 20, I18n.format("Cape Neon green: ON", new Object[0])));
                    CosmeticToggle.saveIsEnabledToFile("CosmeticCape4", Client.CosmeticCape4);
                    break;
                }
                this.buttonList.set(10, new GuiButton(4002, this.width / 2 - 61, this.height / 2 + 150, 120, 20, I18n.format("Cape Neon green: OFF", new Object[0])));
                CosmeticToggle.saveIsEnabledToFile("CosmeticCape4", Client.CosmeticCape4);
                break;
            }
            case 1022: {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, Client.ModFarbe + "Cosmetics", this.width / 2 - 23, this.height / 2 - 120, -1);
