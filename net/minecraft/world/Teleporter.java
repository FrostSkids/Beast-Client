...
public class Teleporter
{
    ...
    private final LongHashMap<PortalPosition> destinationCoordinateCache;
    ...
    public boolean placeInExistingPortal(final Entity entityIn, final float rotationYaw) {
        ...
        if (this.destinationCoordinateCache.containsItem(l)) {
            final PortalPosition teleporter$portalposition = this.destinationCoordinateCache.getValueByKey(l);
            d0 = 0.0;
    ...
    public void removeStalePortalLocations(final long worldTime) {
        if (worldTime % 100L == 0L) {
            ...
            while (iterator.hasNext()) {
                ...
                final PortalPosition teleporter$portalposition = this.destinationCoordinateCache.getValueByKey(olong);
