...
public class ComponentScatteredFeaturePieces
{
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (final EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                if (!this.field_74940_h[enumfacing.getHorizontalIndex()]) {
                    final int l3 = enumfacing.getFrontOffsetX() * 2;
                    final int i4 = enumfacing.getFrontOffsetZ() * 2;
                    this.field_74940_h[enumfacing.getHorizontalIndex()] = this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 10 + l3, -11, 10 + i4, WeightedRandomChestContent.func_177629_a(DesertPyramid.itemsToGenerateInTemple, Items.enchanted_book.getRandom(randomIn)), 2 + randomIn.nextInt(5));
                }
            }
            return true;
        }
    ...
    public static class JunglePyramid extends Feature
    {
        ...
        static {
            ...
            JunglePyramid.junglePyramidsRandomScatteredStones = new Stones();
        }
