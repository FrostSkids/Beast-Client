...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void rotateCorpse(final T bat, final float p_77043_2_, final float p_77043_3_, final float partialTicks) {
        ...
        if (bat.deathTime > 0) {
            ...
            if (s != null && (s.equals("Dinnerbone") || s.equals("Grumm") || s.equals("Ctrl_z") || s.equals("danielsprimetime") || s.equals("shahnamgaming")) && (!(bat instanceof EntityPlayer) || ((EntityPlayer)bat).isWearing(EnumPlayerModelParts.CAPE))) {
