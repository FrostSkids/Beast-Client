...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void func_148171_c(final int p_148171_1_, final int p_148171_2_, final int p_148171_3_, final int p_148171_4_) {
            ...
            final double p_181662_1_ = p_148171_1_ + 0;
            final double p_181662_3_ = p_148171_2_ + 18;
            final GuiFlatPresets this$0 = GuiFlatPresets.this;
            worldRenderer.pos(p_181662_1_, p_181662_3_, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer2 = worldrenderer;
            final double p_181662_1_2 = p_148171_1_ + 18;
            final double p_181662_3_2 = p_148171_2_ + 18;
            final GuiFlatPresets this$2 = GuiFlatPresets.this;
            worldRenderer2.pos(p_181662_1_2, p_181662_3_2, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer3 = worldrenderer;
            final double p_181662_1_3 = p_148171_1_ + 18;
            final double p_181662_3_3 = p_148171_2_ + 0;
            final GuiFlatPresets this$3 = GuiFlatPresets.this;
            worldRenderer3.pos(p_181662_1_3, p_181662_3_3, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer4 = worldrenderer;
            final double p_181662_1_4 = p_148171_1_ + 0;
            final double p_181662_3_4 = p_148171_2_ + 0;
            final GuiFlatPresets this$4 = GuiFlatPresets.this;
            worldRenderer4.pos(p_181662_1_4, p_181662_3_4, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            tessellator.draw();
        }
