        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                if (this.fontRendererObj.getBidiFlag()) {
                    ...
                    s6 = s6 + "" + EnumChatFormatting.BLACK + "_";
                }
                else {
                    s6 = s6 + "" + EnumChatFormatting.GRAY + "_";
                }
            }
                ...
                if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
                    ...
                    final ChatComponentText chatcomponenttext = new ChatComponentText(EnumChatFormatting.DARK_RED.toString() + "* Invalid book tag *");
