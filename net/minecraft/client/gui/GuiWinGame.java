...
public class GuiWinGame extends GuiScreen
{
    ...
    public void initGui() {
        if (this.field_146582_i == null) {
            ...
            try {
                String s = "";
                final String s2 = "" + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + EnumChatFormatting.GREEN + EnumChatFormatting.AQUA;
                final int i = 274;
                ...
                while ((s = bufferedreader.readLine()) != null) {
                    String s3;
                    String s4;
                    for (s = s.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); s.contains(s2); s = s3 + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s4) {
