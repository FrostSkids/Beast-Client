...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    class Details extends GuiSlot
    {
        ...
        private void func_148224_c(final int p_148224_1_, final int p_148224_2_, final int p_148224_3_, final int p_148224_4_) {
            ...
            final WorldRenderer worldRenderer = worldrenderer;
            final double p_181662_1_ = p_148224_1_ + 0;
            final double p_181662_3_ = p_148224_2_ + 18;
            final GuiCreateFlatWorld this$0 = GuiCreateFlatWorld.this;
            worldRenderer.pos(p_181662_1_, p_181662_3_, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 0) * 0.0078125f, (p_148224_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer2 = worldrenderer;
            final double p_181662_1_2 = p_148224_1_ + 18;
            final double p_181662_3_2 = p_148224_2_ + 18;
            final GuiCreateFlatWorld this$2 = GuiCreateFlatWorld.this;
            worldRenderer2.pos(p_181662_1_2, p_181662_3_2, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 18) * 0.0078125f, (p_148224_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer3 = worldrenderer;
            final double p_181662_1_3 = p_148224_1_ + 18;
            final double p_181662_3_3 = p_148224_2_ + 0;
            final GuiCreateFlatWorld this$3 = GuiCreateFlatWorld.this;
            worldRenderer3.pos(p_181662_1_3, p_181662_3_3, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 18) * 0.0078125f, (p_148224_4_ + 0) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer4 = worldrenderer;
            final double p_181662_1_4 = p_148224_1_ + 0;
            final double p_181662_3_4 = p_148224_2_ + 0;
            final GuiCreateFlatWorld this$4 = GuiCreateFlatWorld.this;
            worldRenderer4.pos(p_181662_1_4, p_181662_3_4, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 0) * 0.0078125f, (p_148224_4_ + 0) * 0.0078125f).endVertex();
            tessellator.draw();
        }
