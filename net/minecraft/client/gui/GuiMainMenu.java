...
import Ctrl.BeastClient.GuiLogoButton;
import Ctrl.BeastClient.ScaledResolution;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static String backgroundDate;
    ...
    public void initGui() {
        ...
        if (!Client.LogoButtons) {
            ...
            this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 2 - 24, 200, 20, I18n.format("menu.singleplayer", new Object[0])));
            this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 2, 200, 20, I18n.format("menu.multiplayer", new Object[0])));
            this.buttonList.add(new GuiLogoButton(0, scaledResolution, this.width / 2 - 24, this.height / 2 + 30, 30, 30, new ResourceLocation("Options.png"), false));
            this.buttonList.add(new GuiLogoButton(5, scaledResolution, this.width / 2 + 2, this.height / 2 + 30, 30, 30, new ResourceLocation("Language.png"), false));
            this.buttonList.add(new GuiLogoButton(4, scaledResolution, 6, this.height - 55, 30, 30, new ResourceLocation("quit.png"), false));
        }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation(GuiMainMenu.backgroundDate));
        ...
        final String s = Client.ClientName + " 1.8.8";
        final String s2 = "Copyright Mojang AB. Do not distribute!";
        this.drawString(this.fontRendererObj, s, 2, this.height - 22, -1);
        this.drawString(this.fontRendererObj, s2, 2, this.height - 10, -1);
        Minecraft.getMinecraft().getSession().getUsername();
        final String welcome = "Welcome " + Minecraft.getMinecraft().getSession().getUsername() + "!";
        final net.minecraft.client.gui.ScaledResolution sr = new net.minecraft.client.gui.ScaledResolution(Minecraft.getMinecraft());
        this.drawString(this.fontRendererObj, welcome, 50, sr.getScaledHeight() - 400, -1);
        ...
        if (TileEntityChestRenderer.isChristams) {
            GuiMainMenu.backgroundDate = "Chrismas bakground.png";
        }
        else {
            GuiMainMenu.backgroundDate = "background.png";
        }
