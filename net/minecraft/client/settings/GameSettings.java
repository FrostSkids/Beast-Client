...
public class GameSettings
{
    ...
    public GameSettings(final Minecraft mcIn, final File p_i46326_2_) {
        ...
        this.VAPEV4 = new KeyBinding("Vape Gui", 37, Client.ClientName);
    ...
    public String getKeyBinding(final Options p_74297_1_) {
        final String s = I18n.format(p_74297_1_.getEnumString(), new Object[0]) + ": ";
        if (p_74297_1_.getEnumFloat()) {
            final float f1 = this.getOptionFloatValue(p_74297_1_);
            final float f2 = p_74297_1_.normalizeValue(f1);
            return (p_74297_1_ == Options.SENSITIVITY) ? ((f2 == 0.0f) ? (s + I18n.format("options.sensitivity.min", new Object[0])) : ((f2 == 1.0f) ? (s + I18n.format("options.sensitivity.max", new Object[0])) : (s + (int)(f2 * 200.0f) + "%"))) : ((p_74297_1_ == Options.FOV) ? ((f1 == 70.0f) ? (s + I18n.format("options.fov.min", new Object[0])) : ((f1 == 110.0f) ? (s + I18n.format("options.fov.max", new Object[0])) : (s + (int)f1))) : ((p_74297_1_ == Options.FRAMERATE_LIMIT) ? ((f1 == p_74297_1_.valueMax) ? (s + I18n.format("options.framerateLimit.max", new Object[0])) : (s + (int)f1 + " fps")) : ((p_74297_1_ == Options.RENDER_CLOUDS) ? ((f1 == p_74297_1_.valueMin) ? (s + I18n.format("options.cloudHeight.min", new Object[0])) : (s + ((int)f1 + 128))) : ((p_74297_1_ == Options.GAMMA) ? ((f2 == 0.0f) ? (s + I18n.format("options.gamma.min", new Object[0])) : ((f2 == 1.0f) ? (s + I18n.format("options.gamma.max", new Object[0])) : (s + "+" + (int)(f2 * 100.0f) + "%"))) : ((p_74297_1_ == Options.SATURATION) ? (s + (int)(f2 * 400.0f) + "%") : ((p_74297_1_ == Options.CHAT_OPACITY) ? (s + (int)(f2 * 90.0f + 10.0f) + "%") : ((p_74297_1_ == Options.CHAT_HEIGHT_UNFOCUSED) ? (s + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((p_74297_1_ == Options.CHAT_HEIGHT_FOCUSED) ? (s + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((p_74297_1_ == Options.CHAT_WIDTH) ? (s + GuiNewChat.calculateChatboxWidth(f2) + "px") : ((p_74297_1_ == Options.RENDER_DISTANCE) ? (s + (int)f1 + " chunks") : ((p_74297_1_ == Options.MIPMAP_LEVELS) ? ((f1 == 0.0f) ? (s + I18n.format("options.off", new Object[0])) : (s + (int)f1)) : ((p_74297_1_ == Options.STREAM_FPS) ? (s + TwitchStream.formatStreamFps(f2) + " fps") : ((p_74297_1_ == Options.STREAM_KBPS) ? (s + TwitchStream.formatStreamKbps(f2) + " Kbps") : ((p_74297_1_ == Options.STREAM_BYTES_PER_PIXEL) ? (s + String.format("%.3f bpp", TwitchStream.formatStreamBps(f2))) : ((f2 == 0.0f) ? (s + I18n.format("options.off", new Object[0])) : (s + (int)(f2 * 100.0f) + "%"))))))))))))))));
        }
        ...
        if (p_74297_1_ == Options.GUI_SCALE) {
            return s + getTranslation(GameSettings.GUISCALES, this.guiScale);
        }
        ...
        if (p_74297_1_ == Options.PARTICLES) {
            return s + getTranslation(GameSettings.PARTICLES, this.particleSetting);
        }
        if (p_74297_1_ == Options.AMBIENT_OCCLUSION) {
            return s + getTranslation(GameSettings.AMBIENT_OCCLUSIONS, this.ambientOcclusion);
        }
        if (p_74297_1_ == Options.STREAM_COMPRESSION) {
            return s + getTranslation(GameSettings.STREAM_COMPRESSIONS, this.streamCompression);
        }
        if (p_74297_1_ == Options.STREAM_CHAT_ENABLED) {
            return s + getTranslation(GameSettings.STREAM_CHAT_MODES, this.streamChatEnabled);
        }
        if (p_74297_1_ == Options.STREAM_CHAT_USER_FILTER) {
            return s + getTranslation(GameSettings.STREAM_CHAT_FILTER_MODES, this.streamChatUserFilter);
        }
        if (p_74297_1_ == Options.STREAM_MIC_TOGGLE_BEHAVIOR) {
            return s + getTranslation(GameSettings.STREAM_MIC_MODES, this.streamMicToggleBehavior);
        }
        if (p_74297_1_ == Options.RENDER_CLOUDS) {
            return s + getTranslation(GameSettings.field_181149_aW, this.clouds);
        }
    ...
    public enum Options
    {
        ...
        private Options(final String p_i1015_3_, final boolean p_i1015_4_, final boolean p_i1015_5_) {
            this(p_i1015_3_, p_i1015_4_, p_i1015_5_, 0.0f, 1.0f, 0.0f);
        }
        
        private Options(final String p_i45004_3_, final boolean p_i45004_4_, final boolean p_i45004_5_, final float p_i45004_6_, final float p_i45004_7_, final float p_i45004_8_) {
